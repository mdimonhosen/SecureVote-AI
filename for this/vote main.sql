-- ==============================================================================
-- 1. CLEANUP PREVIOUS TABLES & TRIGGERS
-- ==============================================================================

-- Drop triggers on auth.users (because we don't drop the auth.users table itself)
...
DROP FUNCTION IF EXISTS public.sync_last_sign_in();

-- Drop tables (CASCADE automatically drops any triggers attached to them)
